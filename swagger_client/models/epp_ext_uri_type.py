...
class EppExtURIType(object):
    ...
    @property
    def ext_uri(self):
        """Gets the ext_uri of this EppExtURIType.  # noqa: E501


        :return: The ext_uri of this EppExtURIType.  # noqa: E501
        :rtype: list[str]
        """
        return self._ext_uri

    @ext_uri.setter
    def ext_uri(self, ext_uri):
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EppExtURIType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EppExtURIType):
            return False
