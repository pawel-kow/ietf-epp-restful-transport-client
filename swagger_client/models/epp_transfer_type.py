...
class EppTransferType(object):
    ...
    def __init__(self, op=None):  # noqa: E501
        """EppTransferType - a model defined in Swagger"""  # noqa: E501
        self._op = None
    ...
    @property
    def op(self):
        """Gets the op of this EppTransferType.  # noqa: E501


        :return: The op of this EppTransferType.  # noqa: E501
        :rtype: str
        """
        return self._op
    ...
    def to_dict(self):
        ...
        for attr, _ in six.iteritems(self.swagger_types):
            ...
            if isinstance(value, list):
                ...
                result[attr] = value
        if issubclass(EppTransferType, dict):
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, EppTransferType):
            return False
